...
export default function About() {
  return (
    <>
      ...
      <p>
        When I'm not coding I enjoy spending time with family and friends, I like to read, play video games, travel, and have fun with my little <a href="https://www.instagram.com/lolatheflame/" target="_blank">
          dog
        </a>.
      </p>
      <p>
        It's hard to describe who I think I am, so it's all up to you. If you want to know more about me or my work. {" "}
        <Link href="/contact"> 
          <a>Contact me.</a> 
        </Link>
      </p>
